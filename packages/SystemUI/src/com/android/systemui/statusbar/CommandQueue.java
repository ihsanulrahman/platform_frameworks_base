...
public class CommandQueue extends IStatusBar.Stub implements
    ...
    private static final int MSG_SET_QS_TILES = 78 << MSG_SHIFT;
    private static final int MSG_ENTER_DESKTOP = 79 << MSG_SHIFT;
    private static final int MSG_SET_SPLITSCREEN_FOCUS = 80 << MSG_SHIFT;
    private static final int MSG_TOGGLE_QUICK_SETTINGS_PANEL = 81 << MSG_SHIFT;
    private static final int MSG_TOGGLE_CAMERA_FLASH  = 82 << MSG_SHIFT;
